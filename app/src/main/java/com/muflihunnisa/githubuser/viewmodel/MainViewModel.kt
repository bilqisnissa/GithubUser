package com.muflihunnisa.githubuser.viewmodel
...
class MainViewModel : ViewModel(){
    ...
    fun setListUser(context: Context, query: String? = null) {
        ...
        client.addHeader("Authorization", "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")
            ...
            override fun onSuccess(
                ...
                try {
                    ...
                    for (i in 0 until jsonArray.length()) {
                        ...
                        user.repository = jsonObject.getString("repos_url")
